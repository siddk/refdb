...
entry!('karamcheti2017draggns',
  ...
  inproceedings('First Workshop on Language Grounding for Robotics @ ACL', 2017)
)

entry!('koehn2017six',
  title('Six Challenges for Neural Machine Translation'),
  author('Philipp Koehn and Rebecca Knowles'),
  inproceedings('NMT@ACL', 2017)
)

entry!('hermann2017grounded',
  arxiv(2017, '1706.06551'),
...
entry!('fried2018speakerfollower',
  neurips(2018),
...
entry!('chevalierboisvert2019babyai',
  iclr(2019),
...
entry!('matrone2012real',
  article('Journal of Neuroengineering and Rehabilitation', 2012, 9),
...
entry!('goodrich2013teleoperation',
  article('Reviews of Human Factors and Ergonomics', 2013, 9),
  title('Teleoperation and Beyond for Assistive Humanoid Robots'),
  author('M. A. Goodrich and J. Crandall and E. Barakova'),
  pages(175, 226)
)

entry!('conti2014interface',
  inproceedings('Experimental Robotics', 2014),
...
entry!('muelling2015autonomy',
  arxiv(2015, '1503.05451'),
...
entry!('newman2018harmonic',
  arxiv(2018, '1807.11154'),
...
entry!('losey2018review',
  article('Applied Mechanics Reviews', 2018, 70),
...
entry!('argall2018autonomy',
  article('Annual Review of Control, Robotics, and Autonomous Systems', 2018, 1),
  title('Autonomy in rehabilitation robotics: an intersection'),
  author('Brenna D Argall'),
  pages(441, 463)
)

entry!('openvino2018cvat',
...
entry!('fan2018surreal',
  inproceedings('Conference on Robot Learning', 2018),
...
entry!('wang2019learning',
  ...
  author('Angelina Wang and Thanard Kurutach and Kara Liu and P. Abbeel and A. Tamar')
)

entry!('broad2019highly',
  rss(2019),
  title('Highly parallelized data-driven {MPC} for minimal intervention shared control'),
  author('Alexander Broad and Todd Murphey and Brenna Argall')
)

entry!('chandak2019learning',
  icml(2019),
...
entry!('lynch2019learning',
  arxiv(2019, '1903.01973'),
...
entry!('jing2020selfsupervised',
  article('IEEE transactions on pattern analysis and machine intelligence', 2020),
  title('Self-supervised Visual Feature Learning with Deep Neural Networks: A Survey'),
  author('Longlong Jing and Yingli Tian')
)

entry!('park2020toward',
  article('Robotics and Autonomous Systems', 2020, 124),
...
entry!('grefenstette2019higher',
  arxiv(2019, '1910.01727'),
...
entry!('schmidhuber1991adaptive',
  ...
  techreport('Institut fur Informatik, Technische Universitat Munchen, Arcisstr. 21, 800 Munchen 2', 1991)
)
...
entry!('stolle2002options',
  inproceedings('Proceedings of the 5th International Symposium on Abstraction, Reformulation and Approximation', 2002),
  title('Learning Options in Reinforcement Learning'),
  author('Martin Stolle and Doina Precup')
)

entry!('devlin2012dynamic',
  aamas(2012),
...
entry!('behboudian2020useful',
  arxiv(2020, '2011.01297'),
...
entry!('yun2020evaluating',
  author('Anthony Yun'),
  title('Evaluating the Robustness of Natural Language Reward Shaping Models to Spatial Relations'),
  techreport('The University of Texas at Austin', 2020)
)

entry!('campero2020learning',
  arxiv(2020, '2006.12122'),
